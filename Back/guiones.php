  ...
  <div class="container my-5">
    <div class="row">
      <div class="col-md-8">
        ...
        <p class="lead">Este es un ejemplo de estructura básica usando Bootstrap 5.</p>
      ...
      <div class="col-md-4">
        <div class="card shadow-sm">
          <div class="card-body">
            ...
            <p class="card-text">Puedes usar componentes listos de Bootstrap para organizar tu contenido fácilmente.</p>
